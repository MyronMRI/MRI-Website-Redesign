...
<div id="container" class="index_page">
    ...
    <div id="body">
        <div class="body_main">
            ...
            <div class="body_page">
            	<?php include(PATH_INCLUDES . "include_sidebar_blog2.php"); ?>
				...
				<div class="body_page_main">
					...
					<div class="blog_post index_post">
						<a href="post.php?<?php echo $record['num'] ?>"><h3><?php echo $record['title'] ?></h3></a>
						<em><?php echo date("M j, Y", strtotime($record['post_date'])) ?></em><br />
						...
						<a href="post.php?<?php echo $record['num'] ?>" class="readmore"><img src="/_images/im_next.png" class="blog_arrow" />Read More</a>
						
						<!-- AddThis Button BEGIN -->
						<div class="addthis_toolbox addthis_default_style"
							addthis:url="http://www.marketingresults.net/blog/post.php?<?php echo $record['num'] ?>"
