<section class="well-6 bg-fixed" style="background-image:url('/_img/components_background.jpg');">
    <div class="container text-xs-center">
        <div class="row">
            <div class="col-xs-12">
                    <p class="h3 text-uppercase lightest-blue xs-mt-0 xs-mb-5"><strong><?php echo htmlencode($productsRecord['ksc_header']) ?></strong></p>
                <p class="h2 adelle white xs-mt-0 xs-mb-0"><?php echo htmlencode($productsRecord['ksc_subheader']) ?></p>
            </div>
        </div>
